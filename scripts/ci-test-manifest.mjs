...
export const CI_TEST_MANIFEST = [
  ...
  // Typed-array vectors (Float32Array/Arrow) from LanceDB must materialize as real Arrays on every fetch path
  ...
  { group: "llm-clients-and-auth", runner: "node", file: "test/llm-thinklevel-alias.test.mjs", args: ["--test"] },
  ...
  // Reflection writer-1 source classification (fact/preference/decision -> memory_category)
