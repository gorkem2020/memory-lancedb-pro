...
/**
 * Builds the batch-utility prompt as {system, user}; the two parts ride the
 * prompt-architecture split (`completeJson(user, label, system)`), so the
 * static instructions land in the model's system slot at runtime.
 *
