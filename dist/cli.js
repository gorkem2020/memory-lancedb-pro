    ...
    memory
        ...
        try {
            ...
            const result = await runConsolidate({
                ...
                completeJson: (prompt, label, systemPrompt) => llmClient.completeJson(prompt, label, systemPrompt),
                ...
                onAudit: mdMirror
                    ? async (audit) => {
                        ...
                        await mdMirror({ text: summary, category: "consolidation", scope: audit.scope, timestamp: Date.now() }, { source: `memory-consolidate:${audit.action}` });
                    }
                    : undefined,
            }, {
                scope: options.scope,
