                ...
                const recallWork = async () => {
                    ...
                    return {
                        prependContext: `<relevant-memories>\n` +
                            `<mode:${recallMode}>\n` +
                            `Generated by your memory plugin from your own stored memories and injected automatically at prompt build; not part of the user's message. Relevant historical notes:\n` +
                            `${memoryContext}\n` +
                            `</relevant-memories>`,
            ...
            api.on("before_prompt_build", async (_event, ctx) => {
                ...
                try {
                    ...
                    return {
                        prependContext: [
                            "<inherited-rules>",
                            "Generated by your memory plugin from your own stored reflections and injected automatically at prompt build; not part of the user's message. Treat as stable, long-term behavioral constraints unless the user overrides them.",
                            body,
                            "</inherited-rules>",
                        ].join("\n"),
                    };
                    ...
                    try {
                        ...
                        if (suppression && suppression.until > now) {
                            ...
                            if (derivedLines.length > 0) {
                                blocks.push([
                                    "<derived-focus>",
                                    "Generated by your memory plugin from your own recent reflections and injected automatically at prompt build; not part of the user's message. Weighted recent derived execution deltas:",
